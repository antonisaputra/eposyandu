...
<head>
  ...
  <title>PosyanduRakam</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url(); ?>public_assets/assets/img/favicon.png" rel="icon">
  <link href="<?= base_url(); ?>public_assets/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
