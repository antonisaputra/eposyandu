          ...
          <div class="container-fluid">
            <div class="card mb-4">
              <div class="card-header bg-light">
                <a href="<?= base_url('Halaman/add_bayi_page'); ?>" class="btn btn-primary me-2 ms-2">Tambah</a>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($bayi as $b) : ?>
                            <tr>
                              ...
                              <td>
                                <div class="d-flex">
                                  <a href="<?= base_url('halaman/edit_bayi_page/') . $b->id_bayi; ?>" class="btn btn-warning me-2">Edit</a>
