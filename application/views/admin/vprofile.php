        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?= base_url(); ?>nicepage/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
              ...
              <div class="tab-content pt-2">
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?= base_url(); ?>nicepage/assets/img/profile-img.jpg" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      <label for="Phone" class="col-md-4 col-lg-3 col-form-label">Nomer Telepon</label>
                      <div class="col-md-8 col-lg-9">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Masukkan ulang Password
                        baru</label>
                      <div class="col-md-8 col-lg-9">
